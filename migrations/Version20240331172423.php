 ...
 */
final class Version20240331172423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reading ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C11AFC41A76ED395 ON reading');
        $this->addSql('ALTER TABLE reading DROP user_id');
    }
}
